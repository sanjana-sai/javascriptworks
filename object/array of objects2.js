var filims=[
    ...
    },
    {
        ...
        "director": "Fernando Meirel, Kátia Lund",
...
var movies=filims.filter(m=>m.runtime < 140).map(m=>m.title)
...
var movies=filims.reduce((m1,m2)=>m1.runtime>m2.runtime?m1.title:m2.title)
